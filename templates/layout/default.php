...
<head>
    ...
    <!-- Font Awesome Icons -->
    <?= $this->Html->css('/cake_lte/AdminLTE/plugins/fontawesome-free/css/all.min.css') ?>
    <!-- Theme style -->
    <?= $this->Html->css('/cake_lte/AdminLTE/dist/css/adminlte.min.css') ?>
    <?= $this->Html->css('/cake_lte/css/style.css') ?>
...
<body class="hold-transition <?= $this->CakeLte->getBodyClass() ?>">
    <div class="wrapper">
        ...
        <aside class="main-sidebar <?= $this->CakeLte->getSidebarClass() ?>">
            ...
            <a href="<?= $this->Url->build('/dienstcrm.com.ar') ?>" class="brand-link">
                <?= $this->Html->image('logo-white.png', ['alt' => $this->CakeLte->getConfig('app-name') . ' logo', 'class' => 'brand-image']) ?>
    ...
    <!-- jQuery -->
    <?= $this->Html->script('/cake_lte/AdminLTE/plugins/jquery/jquery.min.js') ?>
    <!-- Bootstrap 4 -->
    <?= $this->Html->script('/cake_lte/AdminLTE/plugins/bootstrap/js/bootstrap.bundle.min.js') ?>
    <!-- AdminLTE App -->
    <?= $this->Html->script('/cake_lte/AdminLTE/dist/js/adminlte.min.js') ?>
